                    ...
                    <div class="table-responsive p-3">
                        <table class="table align-items-center table-flush" id="dataTable">
                            ...
                            <tr v-for="product in filterSearch">
                                ...
                                <td><span v-if="product.product_quantity >= 1" class="badge badge-success">Available</span>
                                    <span v-else="" class="badge badge-danger">StockOut</span></td>
                                <td>{{product.name}}</td>
                                <td>
                                    <router-link :to="{name: 'editproduct', params: {id:product.id}}" value="" class="btn btn-sm btn-primary">Edit</router-link>
