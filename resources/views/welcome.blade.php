...
<head>
  ...
  <link href="{{asset('backened/img/logo/logo.png')}}" rel="icon">
  <title>Inventory Management System</title>
  <link href="{{asset('css/app.css')}}" rel="stylesheet">
  <link href="{{asset('backened/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
  <link href="{{asset('backened/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
  <link href="{{asset('backened/css/ruang-admin.min.css')}}" rel="stylesheet">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
        ...
        <div class="sidebar-brand-icon">
          <img src="{{asset('backened/img/logo/logo2.png')}}">
        </div>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTable7" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <router-link class="collapse-item" to="/allorder">All Orders</router-link>
        ...
        <li class="nav-item">
            <router-link to="stock" class="nav-link collapsed" href="#" aria-expanded="true"
               aria-controls="collapseTable">
                <i class="fas fa-fw fa-table"></i>
                <span>Stock</span>
            </router-link>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="{{asset('backened/img/man.png')}}" style="max-width: 60px" alt="">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="{{asset('backened/img/girl.png')}}" style="max-width: 60px" alt="">
            ...
            <li class="nav-item dropdown no-arrow">
              <router-link to="/logout" class="nav-link dropdown-toggle" href="" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="{{asset('backened/img/boy.png')}}" style="max-width: 60px">
...
<script src="{{asset('js/app.js')}}"></script>
  <script src="{{asset('backened/vendor/jquery/jquery.min.js')}}"></script>
  <script src="{{asset('backened/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
...
<script type="text/javascript">
  ...
  <script src="{{asset('backened/vendor/jquery-easing/jquery.easing.min.js')}}"></script>
  <script src="{{asset('backened/js/ruang-admin.min.js')}}"></script>
  <script src="{{asset('backened/vendor/chart.js/Chart.min.js')}}"></script>
  <script src="{{asset('backened/js/demo/chart-area-demo.js')}}"></script>
